...
export type GetOneProductDetailsBySlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetOneProductDetailsBySlugQuery = { __typename?: 'Query', product?: { __typename?: 'Product', name: string, slug: string, description: string, price: number, images: Array<{ __typename?: 'Asset', url: string, width?: number | null, height?: number | null }> } | null };

export type GetAllProductsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllProductsQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', name: string, slug: string, price: number, images: Array<{ __typename?: 'Asset', id: string, url: string }> }> };
...
export const GetOneProductDetailsBySlugDocument = gql`
...
/**
 * __useGetOneProductDetailsBySlugQuery__
 *
 * To run a query within a React component, call `useGetOneProductDetailsBySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetOneProductDetailsBySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetOneProductDetailsBySlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetOneProductDetailsBySlugQuery(baseOptions?: Apollo.QueryHookOptions<GetOneProductDetailsBySlugQuery, GetOneProductDetailsBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetOneProductDetailsBySlugQuery, GetOneProductDetailsBySlugQueryVariables>(GetOneProductDetailsBySlugDocument, options);
      }
export function useGetOneProductDetailsBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetOneProductDetailsBySlugQuery, GetOneProductDetailsBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetOneProductDetailsBySlugQuery, GetOneProductDetailsBySlugQueryVariables>(GetOneProductDetailsBySlugDocument, options);
        }
export type GetOneProductDetailsBySlugQueryHookResult = ReturnType<typeof useGetOneProductDetailsBySlugQuery>;
export type GetOneProductDetailsBySlugLazyQueryHookResult = ReturnType<typeof useGetOneProductDetailsBySlugLazyQuery>;
export type GetOneProductDetailsBySlugQueryResult = Apollo.QueryResult<GetOneProductDetailsBySlugQuery, GetOneProductDetailsBySlugQueryVariables>;
